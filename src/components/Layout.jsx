...
import {
  ...
  DatabaseBackup, TrendingUp, CalendarCheck, Sparkles,
} from 'lucide-react'
...
const NAV = [
  ...
  { to: '/insights', icon: Sparkles, label: 'Assistente IA' },
  ...
  { to: '/amostras', icon: Palette, label: 'Amostras' },
  { to: '/assistencias', icon: Wrench, label: 'Assistência' },
